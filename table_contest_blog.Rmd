...
Every `gt` table start with the `gt()` function which takes as the first argument a dataframe.
...
If you spot any errors or have feedback, please feel free to reach out to via [twitter](https://twitter.com/kustav_sen) or [email](sen_kaustav@hotmail.com). Stay smart and keep learning!